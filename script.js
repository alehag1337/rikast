...
const TICKER_OVERRIDE_YEAR = {
  "BALDB":       { yearOpen: 76.96, current: 71.4 },
  "Bonesupport": { yearOpen: 398.6, current: 289.2 },
  "Norion Bank": { yearOpen: 38.0,  current: 51.6 },
  "KFast":       { yearOpen: 16.94,  current: 14.18 },
  "Sagax":       { yearOpen: 228.0, current: 221.2 },
  "Sagax D":     { yearOpen: 31.4,  current: 33.75 },
  "Sagax A":     { yearOpen: 228.0, current: 222.0 },
  "Lifco B":     { yearOpen: 326.6, current: 387.6 },
  "LUND-B":      { yearOpen: 507.0, current: 479.0 },
  "HMB":         { yearOpen: 148.75, current: 138.1 },
  "Hexagon B":   { yearOpen: 106.15, current: 95.28 },
  "Volvo":       { yearOpen: 269.8, current: 262.4 },
  "EQT":         { yearOpen: 309.2, current: 320.2},
  "Atlas Copco": { yearOpen: 171.65, current: 156.8 },
  "Sandvik":     { yearOpen: 201.2, current: 221.90 },
  "Securitas":   { yearOpen: 107.65, current: 144.4 },
  "Bure Equity": { yearOpen: 392.4, current: 289.8 },
  "Essity":      { yearOpen: 297.0, current: 268.0 },
  "Skanska":     { yearOpen: 237.1, current: 220.5},
  "Apotea":      { yearOpen: 86.55,  current: 86.75 },
  "Epiroc":      { yearOpen: 195.5, current: 210.6 },
  "AXFO":        { yearOpen: 236.0, current: 291.6},
  "Dustin Group":{ yearOpen: 2.53,  current: 1.85 },
  "Getinge B":   { yearOpen: 183.65, current: 192.7 },
  "Arjo B":      { yearOpen: 36.3,  current: 31.58 },
  "Elanders B":  { yearOpen: 88.0,  current: 60.5 },
  "INDU-C":      { yearOpen: 354.2, current: 348.4 },
  "Holmen B":    { yearOpen: 409.8, current: 378.6 },
  "Handelsbanken A": { yearOpen: 116.1, current: 126.85 },
  "Alleima":     { yearOpen: 76.0,  current: 76.95 },
  "Hufvudstaden":{ yearOpen: 122.3, current: 124.3 },
  "Spotify":     { yearOpen: 4342.91, current: 6933.10 },
  "Latour B":    { yearOpen: 280.3, current: 252.7 },
  "AAK":         { yearOpen: 320.2, current: 255.0},
  "NIBE":        { yearOpen: 43.69,  current: 43.01 },
  "Hexpol":      { yearOpen: 103.1,  current: 93.00 },
  "Assa Abloy":  { yearOpen: 327.8, current: 296.1 },
  "Hoist Finance":{yearOpen: 93.5,  current: 84.7 },
  "Swedish logistic property": { yearOpen: 39.5, current: 41.65 },
  "TFBank":      { yearOpen: 390.0, current: 387.0 },
